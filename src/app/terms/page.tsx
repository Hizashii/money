    ...
    <div className="p-4 sm:p-6 md:p-8 max-w-2xl mx-auto">
      <div className="rounded-2xl bg-white border border-slate-100 p-4 sm:p-6 md:p-8 shadow-sm">
        ...
        <p className="text-slate-600 mb-4">
          By using Incheck you agree to use it responsibly and in line with applicable laws.
        </p>
        ...
        <a href="/" className="inline-block mt-6 text-blue-600 hover:underline text-sm">← Back to Incheck</a>
      </div>
    </div>
  );
}
